      ...
      <section className="max-w-5xl mx-auto px-6 mt-14 grid md:grid-cols-2 gap-8">
        {blogPosts.map((p) => (
          ...
          >
            ...
            <div>
              <h2 className="font-serif-display text-2xl font-semibold text-foreground mb-3 transition-colors duration-300 group-hover:text-accent-blue leading-snug">{p.title}</h2>
              <p className="text-sm text-muted-foreground leading-relaxed line-clamp-3 mb-5">{p.excerpt}</p>
