...
export function DarkGenomeSandbox({ isDark }: { isDark: boolean }) {
  ...
  const stages = [
    ...
    },
    {
      ...
      desc: "Top-left node activates. Dotted line draws from capsule top to the node. Node icon and text fade in with gold glow.",
      durationText: "1.4s",
    ...
    },
    {
      ...
      desc: "Mid-left node activates. Dotted line draws from capsule middle-left. Amber glow pulses along the line.",
      durationText: "1.4s",
      easingText: "easeInOutCubic",
    },
    {
      ...
      desc: "Bottom-left node activates. Dotted line draws from capsule lower section. Indigo glow pulses along the line.",
      durationText: "1.4s",
      easingText: "easeInOutCubic",
    },
    {
      ...
      desc: "Top-right node activates. Dotted line draws from capsule top-right. Copper glow travels to the node.",
      durationText: "1.4s",
      easingText: "easeInOutCubic",
    },
    {
      ...
      desc: "Mid-right node activates. Amber line extends to the ~40% potential card. Band pulses.",
      durationText: "1.4s",
      easingText: "easeInOutCubic",
    },
    {
      ...
      desc: "Bottom-right node activates. Indigo line extends to the ~56% potential card. All 6 nodes now lit.",
      durationText: "1.4s",
      easingText: "easeInOutCubic",
    },
    {
      ...
      desc: "All six nodes are connected. Lines pulse once. Capsule rotation slows and settles in the center.",
      durationText: "1.2s",
      easingText: "easeOutCubic",
    },
    {
      ...
      desc: "Capsule rotates 360°. Bands emit sequential glow from top to bottom and back.",
      durationText: "1.2s",
      easingText: "linear",
    },
    {
  ...
  const renderCard = (
    ...
    return (
      <div
        onClick={() => {
          setActiveStage(badgeNum <= 3 ? badgeNum : badgeNum);
          setIsPlaying(false);
        }}
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className={`h-8 w-8 rounded-full border flex items-center justify-center transition-all ${isActive ? colorClass.activeBorder : "border-border-subtle"} ${isHovered ? "scale-110" : ""}`}
          >
            {icon}
          </div>
          ...
          <span
            className={`h-5 w-5 rounded-full text-[9px] font-mono font-bold flex items-center justify-center border transition-all ${isActive ? `${colorClass.activeBorder} ${colorClass.activeText}` : "border-border-subtle text-zinc-500"} ${isHovered ? "scale-110" : ""}`}
          >
            {badgeNum}
          </span>
        </div>
  ...
  const renderConn = (d: string, stroke: string, nodeIdx: number) => (
    <>
      ...
      <path
        ...
        style={{
          transition: "stroke-dashoffset 1400ms cubic-bezier(0.645,0.045,0.355,1)",
          filter: hoveredNode === nodeIdx || hoveredNode === 99 ? "url(#glow-filter)" : "none",
        }}
        fill="none"
      />
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 pointer-events-none transition-opacity duration-[1500ms] ${activeStage === 8 ? "opacity-75" : "opacity-40"}`}
      >
          ...
          {bgParticles.map((p, i) => (
            <circle
              ...
              style={{
                ...
                animationDuration: `${activeStage === 8 ? p.duration / 2 : p.duration}s`,
              }}
            />
          ))}
        </svg>
          ...
          >
            <defs>
              ...
              <linearGradient id="capsule-shading" x1="0" y1="0" x2="1" y2="0">
                ...
                <stop
                  offset="18%"
                  stopColor={isDark ? "rgba(255,255,255,0.32)" : "rgba(255,255,255,0.65)"}
                />
                <stop
                  offset="45%"
            ...
            <g
              ...
              className={activeStage === 0 ? "capsule-intro" : ""}
            >
        ...
        <div className="flex items-center gap-2 md:gap-3 flex-wrap justify-center font-mono">
          {[
            ...
            return (
              ...
              >
                {st.id}{" "}
                <span className="hidden sm:inline ml-1 font-sans text-[9px] font-semibold tracking-normal">
                  {st.name}
                </span>
              </button>
            );
      ...
      <div className="w-full grid grid-cols-2 md:grid-cols-5 gap-4 mt-8 pt-6 border-t border-border-subtle/30 text-[10px] font-mono text-text-tertiary">
        ...
        <div className="flex items-center gap-1.5 justify-center md:justify-end col-span-2 md:col-span-1">
          ...
          <span>Respects reduce-motion</span>
        </div>
      </div>
    </div>
  );
