...
const getGradient = (name: string) => {
  const gradients = [
    "from-blue-500/20 to-purple-500/20 text-blue-600 dark:text-blue-400 border-blue-500/10",
    "from-purple-500/20 to-emerald-500/20 text-purple-600 dark:text-purple-400 border-purple-500/10",
    "from-emerald-500/20 to-amber-500/20 text-emerald-600 dark:text-emerald-400 border-emerald-500/10",
    "from-amber-500/20 to-blue-500/20 text-amber-600 dark:text-amber-400 border-amber-500/10",
  ];
  let hash = 0;
...
export default function About() {
  ...
  return (
    <PageShell className="!pb-0" spotlight="from-accent-blue/15 via-accent-purple/5 to-transparent">
      {/* Title / Hero */}
      <div className="max-w-6xl mx-auto px-6 mb-8 text-center">
        <p className="text-xs tracking-[0.3em] text-accent-blue dark:text-accent-blue uppercase font-semibold">
          About Quantum Codon
        </p>
        ...
        <p className="mt-4 text-muted-foreground max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
          Quantum Codon is a scientific platform dedicated to exploring the dark genome—uncovering
          silent DNA and non-translating RNA to design novel first-in-class therapies.
        </p>
      </div>

      {/* Sticky Navigation Bar */}
      <div className="sticky top-16 z-30 bg-background/90 backdrop-blur-md border-y border-black/5 dark:border-white/5 py-4 mb-12 shadow-sm transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto px-6 space-y-28 pb-24">
        ...
        <section id="mission" className="scroll-mt-32 space-y-16">
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm md:text-base">
                Biology has historically focused on the 2% of the genome that codes for proteins.
                Quantum Codon was established to explore the final frontier: the remaining 98% that
                nature left silent. By synthetically expressing non-coding DNA and non-translating
                RNA, we design completely new therapeutics that do not exist in natural systems.
              </p>
              ...
              <blockquote className="border-l-2 border-accent-purple pl-5 py-3 italic text-foreground bg-white/45 dark:bg-white/[0.02] border-t border-r border-b border-black/5 dark:border-white/5 rounded-r-2xl pr-4 text-sm font-medium">
                "By synthetically expressing genes that nature kept silent, we are creating a
                completely new class of medicines to treat oncology and infectious diseases."
                <span className="block not-italic mt-2 text-xs font-semibold text-muted-foreground">
                  — Prof. Pawan K Dhar, CSO & Founder
                </span>
              </blockquote>
            </div>
                  ...
                  {slides.map((_, idx) => (
                    <button
                      ...
                      className={`h-2 rounded-full transition-all duration-300 cursor-pointer ${
                        currentSlide === idx
                          ? "w-6 bg-accent-blue"
                          : "w-2 bg-black/10 dark:bg-white/15 hover:bg-black/25 dark:hover:bg-white/30"
                      }`}
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h3 className="font-serif-display text-2xl md:text-3xl mt-2">
                The four pillars of our scientific platform
              </h3>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  color:
                    "border-accent-emerald/15 hover:border-accent-emerald/45 bg-accent-emerald/5",
                  icon: Globe,
                  val: "Amaravati Hub",
                },
                {
        ...
        <section id="leadership" className="scroll-mt-32 space-y-12">
          <div className="text-center max-w-2xl mx-auto">
            <p className="text-[10px] tracking-[0.35em] text-accent-blue uppercase font-semibold">
              Leadership
            </p>
            <h2 className="font-serif-display text-3xl md:text-4xl mt-2 leading-tight">
              The minds behind Quantum Codon
            </h2>
            <p className="mt-2 text-xs md:text-sm text-muted-foreground font-medium">
              Meet our core research, clinical, and database team, using peer-reviewed biology to
              unlock synthetic medicine.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex gap-5 items-center">
                    ...
                    <div className={`h-16 w-16 rounded-2xl border bg-gradient-to-br ${getGradient(leader.name)} shadow-sm shrink-0 flex items-center justify-center font-bold text-lg select-none font-mono`}>
                  ...
                  <p className="text-xs text-muted-foreground mt-4 leading-relaxed">{leader.bio}</p>
                  ...
                  {isExpanded ? (
                    <div className="mt-6 pt-5 border-t border-black/5 dark:border-white/5 space-y-4 animate-in fade-in duration-300">
                      <div>
                        <h4 className="text-[10px] uppercase font-mono tracking-wider text-accent-emerald font-semibold mb-2">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {leader.specialties.map((spec) => (
                            <span
                              key={spec}
                              className="px-2 py-1 rounded bg-black/5 dark:bg-white/5 text-[9px] font-mono border border-black/5 dark:border-white/10 text-muted-foreground"
                            >
                              {spec}
                            </span>
                          ))}
                      ...
                      <div>
                        <h4 className="text-[10px] uppercase font-mono tracking-wider text-accent-purple font-semibold mb-2">
                        ...
                        <ul className="space-y-2">
                          {leader.publications.map((pub) => (
                            <li
                              key={pub}
                              className="text-[10px] leading-relaxed text-muted-foreground flex gap-2"
                            >
        ...
        <section id="events" className="scroll-mt-32 space-y-12">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-2 text-xs md:text-sm text-muted-foreground font-medium">
              Follow where we present our research, outline proof profiles, and interact with the
              biotech ecosystem.
            </p>
          </div>
              ...
              filteredEvents.map((evt) => (
                ...
                >
                  ...
                  <div className="flex md:flex-col items-center justify-center shrink-0 w-20 h-20 bg-slate-900 border border-white/10 rounded-2xl p-2 select-none shadow-md">
                    <span className="text-2xl font-serif-display text-white leading-none font-bold">
                      {evt.day}
                    </span>
                    <span className="text-[9px] font-mono tracking-wider text-muted-foreground uppercase mt-1 md:mt-0.5">
                      {evt.monthYear.split(" ")[0]}
                    </span>
                  </div>
          ...
          <div className="p-8 rounded-3xl border border-black/10 dark:border-white/10 bg-gradient-to-r from-accent-blue/10 via-accent-purple/10 to-accent-emerald/10 text-center max-w-4xl mx-auto">
            ...
            <p className="mt-2 text-xs md:text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              If you are organizing a computational biology symposium or pharmacological conference
              and would like Prof. Pawan K Dhar or members of our bioinformatics core to present,
              please get in touch.
            </p>
            <button
              onClick={contactModal.open}
