...
// --- Sub-component: MolecularBackground Canvas ---
function MolecularBackground({ isDark }: { isDark: boolean }) {
...
// --- Sub-component: Live SVG Diagnostic Waveform ---
function DiagnosticWaveform({ status }: { status: string }) {
        ...
        <section className="max-w-6xl mx-auto px-6 pt-4">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <Reveal delay={100}>
                <h1 className="font-serif-display text-4xl md:text-6xl leading-[1.08] text-text-primary tracking-tight">
                  powering the <br />
        ...
        <section className="bg-bg-raised/20 border-y border-border-subtle/50 py-20 relative overflow-hidden">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
              ...
              <Reveal delay={100}>
                <h2 className="font-serif-display text-3xl md:text-4xl text-text-primary mt-1">
                  Why Quantum Codon
                </h2>
              </Reveal>
              <Reveal delay={200}>
          ...
          <div className="relative rounded-3xl border border-accent-blue/20 bg-gradient-to-br from-accent-blue/10 via-accent-purple/5 to-transparent p-8 md:p-12 shadow-2xl overflow-hidden group">
            ...
            <div className="grid lg:grid-cols-12 gap-10 items-center relative z-10">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <Reveal delay={100}>
                  <h3 className="font-serif-display text-3xl md:text-4xl text-text-primary leading-tight">
