import { A as createLRUCache, M as decodePath, j as invariant, v as createInlineCssPlaceholderAsset, x as getStylesheetHref, y as createInlineCssStyleAsset } from "./react-router+[...].mjs";
...
const INITIAL_SCRIPTS = [dn(SCOPE_ID), "self.$_TSR={h(){this.hydrated=!0,this.c()},e(){this.streamEnded=!0,this.c()},c(){this.hydrated&&this.streamEnded&&(delete self.$_TSR,delete self.$R.tsr)},p(e){this.initialized?e():this.buffer.push(e)},buffer:[]}"];
