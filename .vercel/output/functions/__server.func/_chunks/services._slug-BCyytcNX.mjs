							...
							children: filteredItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "text-[10px] tracking-wide font-bold uppercase rounded-md px-2.5 py-1 bg-slate-900/90 text-white backdrop-blur shadow-sm",
												children: item.categoryType
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "text-[10px] tracking-wide font-bold uppercase rounded-md px-2.5 py-1 bg-[#10b981]/90 text-white backdrop-blur shadow-sm",
												children: item.topic
											})]
										})
									]
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "text-[11px] font-semibold text-[#10b981] tracking-wider uppercase mb-2",
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-[10px] font-mono text-text-tertiary block mb-1",
										children: stage.num
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
										className: "font-sans text-xs md:text-sm font-semibold text-text-primary leading-tight mb-2.5",
										children: stage.name
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-[11px] text-text-secondary leading-relaxed mb-4 font-medium min-h-[72px]",
										children: stage.details
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: `mt-auto px-2 py-0.5 text-[8px] font-mono font-bold border rounded-full transition-colors duration-350 ${isCurrent || isReached ? stage.badgeColor : "border-border-subtle/20 text-text-secondary/80 bg-border-subtle/10"}`,
										children: stage.tag
									})
								]
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "text-[9px] font-mono font-bold tracking-widest text-text-tertiary uppercase",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[10px] font-mono text-accent-blue dark:text-accent-emerald font-semibold uppercase tracking-wide mb-3",
						...
						className: "mt-4 pt-3 border-t border-border-subtle/20 flex justify-between items-center text-[9px] font-mono text-text-tertiary",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "hidden lg:grid grid-cols-12 gap-4 px-6 py-4 border-b border-border-subtle/40 bg-bg-raised/40 text-[10px] font-mono uppercase tracking-wider font-bold text-text-tertiary",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
